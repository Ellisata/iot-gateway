...
<!-- 管理控制台概览：以可点击封面代替 <video> —— Gitee/GitHub 的 Markdown 清洗器
     会丢弃 video 标签，页面上一片空白；图片则任何平台都能渲染。
     封面为改版后的大盘截图，点击进入 docs/video/ 下的中文版演示视频 -->
[![管理控制台概览](docs/images/dashboard.zh.png)](docs/video/演示视频.mp4)
